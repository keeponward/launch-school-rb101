...
def tfidf(term, document, documents)
  # tf_result = tf(term, document)
  # idf_result = idf(term, documents)
  # puts "term = #{term}  tf_result = #{tf_result}  idf_result = #{idf_result}"
  tf(term, document) * idf(term, documents)
  # tf_result * idf_result
end
...
def idf(term, documents)
  ...
  # puts "number_of_documents = #{number_of_documents}  number_of_documents_with_term = #{number_of_documents_with_term}"
